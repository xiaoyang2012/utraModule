...
SOPCINFO_FILE := E:/xiaoyang/work/utraScan/code/utraSonic/utraModule/kernel/kernel.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10041038
SOPC_SYSID_FLAG += --sidp=0x10041038
ELF_PATCH_FLAG  += --sidp 0x10041038

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1383902768
SOPC_SYSID_FLAG += --timestamp=1383902768
ELF_PATCH_FLAG  += --timestamp 1383902768
