...
SOPCINFO_FILE := E:/work/utraScan/code/utraSonic/utraModule/kernel/kernel.sopcinfo
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10041158
SOPC_SYSID_FLAG += --sidp=0x10041158
ELF_PATCH_FLAG  += --sidp 0x10041158

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1385000072
SOPC_SYSID_FLAG += --timestamp=1385000072
ELF_PATCH_FLAG  += --timestamp 1385000072
